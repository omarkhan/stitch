(function() {
  var CoffeeScript, Package, async, ck, compilers, eco, extname, fs, join, normalize, _, _ref;
  ...
  try {
    ...
    compilers.ck = function(module, filename) {
      var content;
  ...
  exports.Package = Package = (function() {
    ...
    Package.prototype.compileDependencies = function(callback) {
      return async.map(this.dependencies, this.compileFile, __bind(function(err, dependencySources) {
        if (err) {
          return callback(err);
        } else {
